...
voc_07 = '../data/VOCdevkit'
voc_12 = '../data/VOCdevkit'


anno_path = './data/VOCdevkit/Annotations'
img_path = r'.data/VOCdevkit/JPEGImages'
...
trainval_path = ['../data/VOCdevkit/ImageSets/Main/trainval.txt']
test_path = ['../data/VOCdevkit/ImageSets/Main/test.txt']
